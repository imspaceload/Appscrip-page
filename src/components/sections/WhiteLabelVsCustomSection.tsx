    ...
    >
      <div className="container mx-auto px-6 max-w-[1280px]">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* White-Label Card */}
          <div className="relative border-2 border-[var(--color-primary)] rounded-2xl overflow-hidden">
            ...
            <div className="p-8">
              ...
              <div className="mb-6">
                <h4 className="text-sm font-semibold text-[var(--color-secondary)] mb-3 uppercase tracking-wider">
                  Advantages
                </h4>
              ...
              <div className="pt-4 border-t border-gray-200">
                ...
                <p className="text-3xl font-bold text-[var(--color-secondary)]">
                  $15,000 <span className="text-sm font-normal text-gray-500">- $40,000</span>
                </p>
              </div>
            </div>
          </div>
